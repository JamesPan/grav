...
hljs: true
jscomments:
  id: /2015/09/29/deploy-wekan-with-docker/
  title: 使用 Docker Compose 部署 Wekan
  url: http://blog.jamespan.me/2015/09/29/deploy-wekan-with-docker/
routes:
  aliases:
  - posts/deploy-wekan-with-docker
  default: /2015/09/29/deploy-wekan-with-docker
taxonomy:
  category:
  - blog
  - Study
